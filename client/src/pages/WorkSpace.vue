  ...
  <div class="ws-layout relative">
      ...
      <div class="ws-sidebar-footer">
        <div class="ws-plan-card">
          ...
          <div class="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden">
            <div
              class="bg-gradient-to-r from-[#5855F6] to-[#F0428A] h-1.5 rounded-full transition-all duration-1000"
          ...
          <div class="ws-search-container">
            <div class="ws-search-wrapper group">
              ...
              <div class="hidden md:flex items-center gap-1 opacity-50">
                <kbd
                  class="px-1.5 py-0.5 bg-gray-100 border border-gray-200 rounded text-[10px] font-sans font-bold text-gray-500"
                  >⌘</kbd
                >
                <kbd
                  class="px-1.5 py-0.5 bg-gray-100 border border-gray-200 rounded text-[10px] font-sans font-bold text-gray-500"
          ...
          >
            ...
            <div class="ws-card-preview" :class="getCardColor(index)">
              <div class="ws-mini-form">
                ...
                <div
                  class="w-full h-5 bg-white rounded border border-gray-100 shadow-sm"
                ></div>
                <div
                  class="w-4/5 h-5 bg-white rounded border border-gray-100 shadow-sm"
                ></div>
                <div
                  class="w-1/3 h-5 bg-[#5855F6]/20 rounded border border-[#5855F6]/10 mt-auto"
                ></div>
              </div>
              ...
              <div class="ws-card-badge">
                <span
                  ...
                  :class="form.is_published ? 'bg-emerald-500' : 'bg-gray-400'"
                ></span>
            ...
            <div class="ws-card-info">
              <div class="flex items-start justify-between">
                ...
                <!-- Quick Actions (Hover) -->
                <div
                  class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity bg-white pl-2"
                >
                  <!-- Edit Button -->
                  <button
                  ...
                  <button
                    @click="openPublishModal(form)"
                    class="p-1.5 text-gray-400 rounded-md transition-colors"
                    :class="
                      form.is_published
                  ...
                  <!-- Delete Button -->
                  <button
                    @click="openDeleteModal(form._id)"
    ...
    >
      ...
      >
        ...
        <!-- Modal Content -->
        <div
          class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 overflow-hidden"
        >
          <div
            class="w-12 h-12 rounded-full bg-red-100 text-red-500 flex items-center justify-center mb-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <svg
              v-if="!publishModal.form.is_published"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"

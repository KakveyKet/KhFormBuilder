  ...
  <div class="min-h-screen flex bg-white font-sans">
    ...
    >
      ...
      <div class="relative z-10 w-full max-w-lg px-8 text-left">
        ...
        <div
          class="p-8 bg-white/5 backdrop-blur-md rounded-[32px] border border-white/10 shadow-2xl relative"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            ...
            stroke="#F0428A"
            stroke-width="2"
            class="absolute -top-4 -right-4 animate-pulse"
          >
            <path
          ...
          <div class="flex items-center justify-between mb-8">
            <div class="text-white">
              <div
                class="text-xs uppercase tracking-widest text-indigo-300 font-bold mb-1"
              >
                Current Balance
              </div>
          ...
          <div class="space-y-3">
            <div class="h-2 w-full bg-white/10 rounded-full overflow-hidden">
              <div
                class="h-full w-full bg-gradient-to-r from-[#5855F6] to-[#F0428A] animate-pulse"
              ></div>
            </div>
            <div
              class="flex justify-between text-[11px] font-bold text-indigo-300 uppercase tracking-tighter"
            >

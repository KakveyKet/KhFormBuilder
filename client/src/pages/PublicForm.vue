<template>
    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 flex justify-center items-start transition-colors duration-500"
        ...
        <!-- 4. Main Form Area -->
        <div v-else
            class="max-w-3xl w-full bg-[var(--tpl-bg)] rounded-2xl shadow-2xl overflow-hidden mt-6 animate-fade-up">
            ...
            <div class="p-8 sm:p-12">
                ...
                <div class="mb-10 pb-8 border-b" style="border-color: var(--tpl-border);">
                    <!-- Removed static Tailwind font/text classes to let inline typography styles override properly -->
                    ...
                    <div v-for="field in formData.schema" :key="field.id" class="flex flex-col">
                        ...
                        <label v-else-if="field.type === 'checkbox'"
                            ...
                            <div class="relative flex items-center justify-center">
                                ...
                                <div class="absolute inset-0 rounded pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity flex items-center justify-center"
                            ...
                            <span
                                class="text-[16px] font-medium select-none transition-colors opacity-90 hover:opacity-100"
                        ...
                        <div v-else-if="field.type === 'range'"
                            class="flex items-center gap-5 mt-2 border p-5 rounded-xl shadow-sm"
...
onMounted(() => {
    // Automatically grab the ID from Vue Router /public/:id
...
const fetchForm = async () => {
    try {
        ...
        // 🌟 Ensure typography object safely exists if fetching an older form from the database
        if (!data.typography) {
            data.typography = {
        ...
        // Initialize answers object based on type, checking if schema exists
...
const submitForm = async () => {
    ...
    try {
        ...
        // Fake network delay (Replace with your actual POST request later)

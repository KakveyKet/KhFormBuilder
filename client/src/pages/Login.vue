<template>
  <div class="min-h-screen flex bg-white font-sans">
    ...
    >
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="flex items-center gap-2 mb-10">
          <div
            class="w-10 h-10 bg-[#5855F6] rounded-xl flex items-center justify-center shadow-md"
          >
            <svg
              width="20"
              height="20"
        ...
        <div class="mt-8">
          ...
          <div class="relative mt-6">
            ...
            >
              <span class="bg-white px-6 text-gray-500"
          ...
          <form class="mt-6 space-y-5" @submit.prevent="handleLogin">
            ...
            <div class="space-y-1.5">
              <div class="flex items-center justify-between mb-1.5">
                ...
                <a
                  href="#"
                  class="text-sm font-semibold text-[#5855F6] hover:text-[#4338CA] transition-colors"
                  >Forgot password?</a
                >
              </div>
              <div class="relative group">
          ...
          <p class="mt-8 text-center text-sm text-gray-500">
            ...
            <a
              href="/register"
              class="font-semibold text-[#5855F6] hover:text-[#4338CA] transition-colors"
              >Sign up for free</a
            >
          </p>
        </div>
    ...
    <div
      class="hidden lg:flex lg:flex-1 relative bg-[#0B0F19] overflow-hidden items-center justify-center"
    >
      <div
        class="absolute inset-0 bg-gradient-to-br from-[#1E1B4B] via-[#0B0F19] to-[#312E81] opacity-90"
      ></div>
      <div
      ...
      <div class="relative z-10 w-full max-w-lg px-8 text-left">
        ...
        <div
          class="p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl"
        >
          <div
            class="flex items-center gap-4 mb-6 pb-6 border-b border-white/10"
          >
            <div
          ...
          <div class="space-y-4">
            <div class="flex gap-4">
              <div
                class="h-10 w-1/2 bg-white/10 rounded-lg animate-pulse"
              ></div>
              <div
                class="h-10 w-1/2 bg-white/10 rounded-lg animate-pulse"
            ...
            <div
              class="h-10 w-full bg-white/10 rounded-lg animate-pulse"
...
const handleLogin = async () => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:3000/api/authRoutes/login",
      {
